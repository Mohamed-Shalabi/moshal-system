...
hi  Normal                                  ctermfg=12  ctermbg=8  guifg=#eeeeee  guibg=#000000  gui=NONE
...
hi  Cursor                                  ctermfg=8  ctermbg=10  guifg=#000000  guibg=#61707a  gui=NONE
hi  CursorColumn                            ctermbg=0  guibg=#1d252b  gui=NONE
hi  CursorLine                              cterm=NONE  ctermbg=0  guibg=#1d252b  guisp=#808487  gui=NONE
hi  CursorLineNr                            cterm=NONE ctermfg=12  guifg=#eeeeee  gui=bold
...
hi  Error                                   cterm=NONE  ctermfg=1  ctermbg=NONE  guifg=#ba656d  guibg=#000000  gui=NONE
hi  ErrorMsg                                cterm=reverse  ctermfg=1  ctermbg=NONE  guifg=#ba656d  guibg=NONE gui=reverse
hi  FoldColumn                              ctermfg=12  ctermbg=0  guifg=#eeeeee  guibg=#1d252b  gui=NONE
hi  Folded                                  cterm=NONE,underline  ctermfg=12  ctermbg=0  guifg=#eeeeee  guibg=#1d252b  guisp=#000000  gui=NONE
...
hi  Pmenu                                   cterm=reverse  ctermfg=12  ctermbg=0  guifg=#eeeeee  guibg=#1d252b  gui=reverse
hi  PmenuSbar                               cterm=reverse  ctermfg=7  ctermbg=12  guifg=#e6eaed  guibg=#eeeeee  gui=reverse
hi  PmenuSel                                cterm=reverse  ctermfg=10  ctermbg=7  guifg=#61707a  guibg=#e6eaed  gui=reverse
hi  PmenuThumb                              cterm=reverse  ctermfg=12  ctermbg=8  guifg=#eeeeee  guibg=#000000  gui=reverse
...
hi  SignColumn                              cterm=NONE  ctermfg=12  ctermbg=NONE  guifg=#eeeeee  guibg=NONE  gui=NONE
...
hi  StatusLine                              cterm=reverse  ctermfg=10  ctermbg=8  guifg=#61707a  guibg=#000000  gui=reverse
hi  StatusLineNC                            cterm=reverse  ctermfg=11  ctermbg=0  guifg=#6d767d  guibg=#1d252b  gui=reverse
hi  TabLine                                 cterm=underline  ctermfg=12  ctermbg=0  guifg=#eeeeee  guibg=#1d252b  guisp=#eeeeee  gui=underline
hi  TabLineFill                             cterm=underline  ctermfg=12  ctermbg=0  guifg=#eeeeee  guibg=#1d252b  guisp=#eeeeee  gui=underline
hi  TabLineSel                              cterm=underline,reverse  ctermfg=10  ctermbg=7  guifg=#61707a  guibg=#e6eaed  guisp=#eeeeee  gui=underline,reverse
...
hi  Visual                                  cterm=reverse  ctermfg=10  ctermbg=8  guifg=#61707a  guibg=#000000  gui=reverse
...
hi  gitcommitFile                           cterm=NONE  ctermfg=12  guifg=#eeeeee  gui=NONE
...
hi  pandocBlockQuoteLeader5                 ctermfg=12  guifg=#eeeeee  gui=NONE
...
hi  pandocEmphasis                          ctermfg=12  guifg=#eeeeee  gui=italic
...
hi  pandocEmphasisNested                    cterm=NONE  ctermfg=12  guifg=#eeeeee  gui=NONE
...
hi  pandocStrongEmphasis                    cterm=NONE  ctermfg=12  guifg=#eeeeee  gui=NONE
hi  pandocStrongEmphasisDefinition          cterm=NONE  ctermfg=13  guifg=#8e6fbd  gui=NONE
hi  pandocStrongEmphasisEmphasis            cterm=NONE  ctermfg=12  guifg=#eeeeee  gui=NONE
...
hi  pandocStrongEmphasisNested              cterm=NONE  ctermfg=12  guifg=#eeeeee  gui=NONE
...
hi  pandocTableZebraLight                   ctermfg=4  ctermbg=8  guifg=#4384b0  guibg=#000000  gui=NONE
...
hi  perlHereDoc                             ctermfg=14  ctermbg=8  guifg=#808487  guibg=#000000  gui=NONE
hi  perlStatementFileDesc                   ctermfg=6  ctermbg=8  guifg=#35898c  guibg=#000000  gui=NONE
hi  perlVarPlain                            ctermfg=3  ctermbg=8  guifg=#947b38  guibg=#000000  gui=NONE

hi  rubyDefine                              cterm=NONE  ctermfg=14  ctermbg=8  guifg=#808487  guibg=#000000  gui=NONE

hi  texMathMatcher                          ctermfg=3  ctermbg=8  guifg=#947b38  guibg=#000000  gui=NONE
hi  texMathZoneX                            ctermfg=3  ctermbg=8  guifg=#947b38  guibg=#000000  gui=NONE
hi  texRefLabel                             ctermfg=3  ctermbg=8  guifg=#947b38  guibg=#000000  gui=NONE
hi  texStatement                            ctermfg=6  ctermbg=8  guifg=#35898c  guibg=#000000  gui=NONE
